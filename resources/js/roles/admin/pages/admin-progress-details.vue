                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="breadcrumb mb-4 mt-3">
                            <Breadcrumb>
                                ...
                                <BreadcrumbItem to="/admin/progress-cases" class="breadcrumb-item">Case progress</BreadcrumbItem>
                                <BreadcrumbItem :to="`/admin/progress-cases/${data.caseId}`" class="breadcrumb-item active">
