                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="breadcrumb mb-4 mt-3">
                            <Breadcrumb>
                                ...
                                <BreadcrumbItem to="/reports/completed-cases" class="breadcrumb-item">Completed cases
                                </BreadcrumbItem>
                                <BreadcrumbItem :to="`/reports/cases-progress/${data.caseId}`"
                        ...
                        <CaseDetails :case_id="data.caseId" :role="data.role" :Rstatus="data.Rstatus" :stage="data.stage"
                            ...
                            :final="data.final" :actionTitle="data.actionTitle" />
    ...
    data() {
        return {
            data: {
                ...
                progressPath: '/reports/completed-cases',
