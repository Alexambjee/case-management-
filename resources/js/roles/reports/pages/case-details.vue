                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="breadcrumb mb-4 mt-3">
                            <Breadcrumb>
                                ...
                                <BreadcrumbItem to="/reports/my-cases" class="breadcrumb-item">New cases</BreadcrumbItem>
                                <BreadcrumbItem :to="`/reports/my-cases/${data.caseId}`" class="breadcrumb-item active">
