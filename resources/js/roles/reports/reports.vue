                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <router-link to="/reports/my-cases">
                            ...
                            <!-- Taxpayer Response -->
                            <div class="col-xl-3 col-md-6">
                                <router-link to="/reports/cases-progress">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <router-link to="/reports/under-review-cases">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <router-link to="/reports/completed-cases">
    ...
    data() {
        return {
            ...
            data: {
                ...
                RolePath: '/reports/Temporary-role-change',
                closedPath: '/reports/closed-cases',
