                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="breadcrumb mb-4 mt-3">
                            <Breadcrumb>
                                ...
                                <BreadcrumbItem to="/initiator/my-cases" class="breadcrumb-item">My cases</BreadcrumbItem>
                                <BreadcrumbItem :to="`/initiator/my-cases/${data.caseId}`" class="breadcrumb-item active">
