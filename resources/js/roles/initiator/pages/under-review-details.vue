<template>
    <div>
        ...
        <div id="layoutSidenav">
            <Sidebar :messagePath="data.messagePath" :channel="data.channel" />
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="breadcrumb mb-4 mt-3">
                            <Breadcrumb>
                                ...
                                <BreadcrumbItem to="/initiator/under-review-cases" class="breadcrumb-item">Under review
                                    cases
                                </BreadcrumbItem>
                                <BreadcrumbItem :to="`/initiator/sent-back-cases/${data.caseId}`"
